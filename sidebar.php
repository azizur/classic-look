...
<li class="widget widget_text" id="text-4"><h3>New Visitor?</h3>			<div class="textwidget"><div class="start-here-sidebar">
    <a onclick="_gaq.push(['_trackEvent','StartHere-Banner-Sidebar','Visited Start Here Page from Sidebar','Widget-Sidebar-StartHere',,false]);" href="http://www.productivemuslim.com/start-here/">
        <img width="90" height="90" src="<?php echo get_theme_root_uri(); ?>/classic-look/starthere.png" alt="Start Here | Productive Muslim"> Visiting our site for the first time? Explore our A-Z guide to read, follow and watch.</a>
</div></div>
		</li><li class="widget widget_text" id="text-9"><h3>FREE EBOOK!</h3>			<div class="textwidget"><p class="sidebar-skin-intro">Subscribe to our weekly newsletter and receive a <strong>free copy of our eBook</strong> "The Very Best of ProductiveMuslim"</p>
